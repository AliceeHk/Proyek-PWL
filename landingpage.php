...
<body>
 <?php
  ...
  <div id="booklist">
    <?php
    $result = $mysqli->query("SELECT * FROM buku LIMIT 6") or die($mysqli->error);
    ...
    foreach ($books as $book): ?>
      <a href="../description/deskripsi.php?bookId=<?= $book['id'] ?>" class="book">
        <div class="img"><img src="<?= $book['sampul'] ?>" alt="<?= $book['judul'] ?>"></div>
  ...
  <a href="../allbooks/allbookspage.php"><p id="viewall">View All</p></a>
  <hr />
...
<div id="category">
    ...
    foreach ($categories as $class => $label) {
      // PERBAIKI PATH: dari /../../pages/ menjadi ../category/
      echo "<a href='../category/categorypage.php?category=$class' id='cat'><p class='$class'>$label</p></a>";
    }
    ?>
</div>
